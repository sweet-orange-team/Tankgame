...
//敌方坦克
Tank_Enemies::Tank_Enemies(Map &map, int id, int blood, int armour, int speed, Color color, int direction) :Tank(map, blood, armour, speed, color, direction)                 //构造函数，设定初始属性
{
